    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <PageSection size={SectionSize.X_Small} color="#ddd" background="#1a2838">
              <UserImg />
            </PageSection>
            {/* Section One: About - Info */}
            <PageSection size={SectionSize.Wide} color="#112244" background="#ddd">
              <h2>Hello, I'm Josh. A front-end web developer.</h2>
              <p style={{ textAlign: "left" }}>
              I've been working as a developer in Chester for 3 years now. I specialise in creating <span className="pf-standout">React</span> applications with <span className="pf-standout">Typescript</span>. 
              However, I am familiar with a lot of other frameworks, libraries, and technologies because I work on various projects which require different expertise, allowing me to continually <span className="pf-standout">upskill</span> myself. 
              I love problem-solving, whether it's diagnosing a technical issue, solving problems for clients, or just finding better ways to work effectively.
              </p>
            </PageSection>
          </SectionBlock>
        </HoverZoom>
      ...
      >
        ...
        >
          ...
          <PageSection size={SectionSize.Medium} color="#112244" background="#ddd">
            <h3>To do</h3>
            
            <SectionBlock direction={FlexDirection.Vertical}
              type={SectionType.Spaced}
              background={null}>
                <PageSection size={SectionSize.Fill} color="#1a2838" background="#fff">
      ...
      >
        ...
        <p>
          I will put info about my job here i guess, what i do, skills, things
          ive worked on etc...
        </p>
      </PageSection>
      ...
      >
        ...
        >
          ...
          <PageSection size={SectionSize.Wide} color="#ddd" background="#0066dd">
